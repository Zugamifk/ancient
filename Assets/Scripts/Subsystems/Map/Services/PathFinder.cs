...
namespace Map.Services
{
    ...
    {
        public PathModel GetDirectPath(Vector2Int start, Vector2Int end, IGridModel grid)
        {
        ...
        public PathModel GetPath(Vector2Int start, Vector2Int end, IGridModel grid)
        {
